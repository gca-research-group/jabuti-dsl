...
public class JabutiParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, JabutiGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getConditionalTermAccess().getAlternatives_2_0(), "rule__ConditionalTerm__Alternatives_2_0");
			builder.put(grammarAccess.getConditionalTermAccess().getAlternatives_2_1_1(), "rule__ConditionalTerm__Alternatives_2_1_1");
			builder.put(grammarAccess.getConditionalTermAccess().getAlternatives_3_2_1(), "rule__ConditionalTerm__Alternatives_3_2_1");
			...
			builder.put(grammarAccess.getConditionalTermAccess().getGroup_2(), "rule__ConditionalTerm__Group_2__0");
			builder.put(grammarAccess.getConditionalTermAccess().getGroup_2_1(), "rule__ConditionalTerm__Group_2_1__0");
			builder.put(grammarAccess.getConditionalTermAccess().getGroup_3(), "rule__ConditionalTerm__Group_3__0");
			builder.put(grammarAccess.getConditionalTermAccess().getGroup_3_2(), "rule__ConditionalTerm__Group_3_2__0");
			...
			builder.put(grammarAccess.getConditionalTermAccess().getComparisonOperatorAssignment_2_1_0(), "rule__ConditionalTerm__ComparisonOperatorAssignment_2_1_0");
			builder.put(grammarAccess.getConditionalTermAccess().getLogicalOperatorAssignment_3_0(), "rule__ConditionalTerm__LogicalOperatorAssignment_3_0");
			builder.put(grammarAccess.getConditionalTermAccess().getComparisonOperatorAssignment_3_2_0(), "rule__ConditionalTerm__ComparisonOperatorAssignment_3_2_0");
			builder.put(grammarAccess.getConditionalTermAccess().getExpressionTermAssignment_7(), "rule__ConditionalTerm__ExpressionTermAssignment_7");
