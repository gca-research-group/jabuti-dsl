...
public class JabutiParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, JabutiGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getConditionalExpressionAccess().getAlternatives_2_0(), "rule__ConditionalExpression__Alternatives_2_0");
			builder.put(grammarAccess.getConditionalExpressionAccess().getAlternatives_2_1_1(), "rule__ConditionalExpression__Alternatives_2_1_1");
			builder.put(grammarAccess.getConditionalExpressionAccess().getAlternatives_3_2_1(), "rule__ConditionalExpression__Alternatives_3_2_1");
			...
			builder.put(grammarAccess.getMessageContentAccess().getAlternatives_4(), "rule__MessageContent__Alternatives_4");
			...
			builder.put(grammarAccess.getConditionalExpressionAccess().getGroup_2(), "rule__ConditionalExpression__Group_2__0");
			builder.put(grammarAccess.getConditionalExpressionAccess().getGroup_2_1(), "rule__ConditionalExpression__Group_2_1__0");
			builder.put(grammarAccess.getConditionalExpressionAccess().getGroup_3(), "rule__ConditionalExpression__Group_3__0");
			builder.put(grammarAccess.getConditionalExpressionAccess().getGroup_3_2(), "rule__ConditionalExpression__Group_3_2__0");
			...
			builder.put(grammarAccess.getTimeUnitSpecAccess().getGroup(), "rule__TimeUnitSpec__Group__0");
			...
			builder.put(grammarAccess.getClauseAccess().getOnSuccessAssignment_12(), "rule__Clause__OnSuccessAssignment_12");
			builder.put(grammarAccess.getClauseAccess().getOnBreachAssignment_13(), "rule__Clause__OnBreachAssignment_13");
			...
			builder.put(grammarAccess.getPlusAccess().getSymbolAssignment_1_1_0(), "rule__Plus__SymbolAssignment_1_1_0");
			builder.put(grammarAccess.getPlusAccess().getSymbolAssignment_1_1_1(), "rule__Plus__SymbolAssignment_1_1_1");
			builder.put(grammarAccess.getPlusAccess().getRightAssignment_1_2(), "rule__Plus__RightAssignment_1_2");
			builder.put(grammarAccess.getFactorAccess().getSymbolAssignment_1_1_0(), "rule__Factor__SymbolAssignment_1_1_0");
			builder.put(grammarAccess.getFactorAccess().getSymbolAssignment_1_1_1(), "rule__Factor__SymbolAssignment_1_1_1");
			...
			builder.put(grammarAccess.getConditionalExpressionAccess().getComparisonOperatorAssignment_2_1_0(), "rule__ConditionalExpression__ComparisonOperatorAssignment_2_1_0");
			builder.put(grammarAccess.getConditionalExpressionAccess().getLogicalOperatorAssignment_3_0(), "rule__ConditionalExpression__LogicalOperatorAssignment_3_0");
			builder.put(grammarAccess.getConditionalExpressionAccess().getComparisonOperatorAssignment_3_2_0(), "rule__ConditionalExpression__ComparisonOperatorAssignment_3_2_0");
			builder.put(grammarAccess.getConditionalExpressionAccess().getExpressionTermAssignment_7(), "rule__ConditionalExpression__ExpressionTermAssignment_7");
			...
			builder.put(grammarAccess.getMessageContentAccess().getContentAssignment_4_0(), "rule__MessageContent__ContentAssignment_4_0");
