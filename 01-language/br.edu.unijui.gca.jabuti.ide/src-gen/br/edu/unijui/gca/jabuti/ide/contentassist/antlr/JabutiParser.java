...
public class JabutiParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, JabutiGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getMessageContentAccess().getGroup_5(), "rule__MessageContent__Group_5__0");
			...
			builder.put(grammarAccess.getMessageContentAccess().getComparisonOperatorAssignment_3(), "rule__MessageContent__ComparisonOperatorAssignment_3");
			builder.put(grammarAccess.getMessageContentAccess().getExpressionAssignment_4(), "rule__MessageContent__ExpressionAssignment_4");
			builder.put(grammarAccess.getMessageContentAccess().getTimeUnitAssignment_5_1(), "rule__MessageContent__TimeUnitAssignment_5_1");
