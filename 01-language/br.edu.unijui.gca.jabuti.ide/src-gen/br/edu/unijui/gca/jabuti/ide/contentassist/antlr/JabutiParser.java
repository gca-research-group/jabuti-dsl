...
public class JabutiParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, JabutiGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getClauseAccess().getConditionAssignment_10(), "rule__Clause__ConditionAssignment_10");
			...
			builder.put(grammarAccess.getVariableAccess().getTermAssignment_1_2(), "rule__Variable__TermAssignment_1_2");
			...
			builder.put(grammarAccess.getMaxNumberOfOperationAccess().getOperationNumberAssignment_2(), "rule__MaxNumberOfOperation__OperationNumberAssignment_2");
			...
			builder.put(grammarAccess.getMessageContentAccess().getStrValueAssignment_2_4_0(), "rule__MessageContent__StrValueAssignment_2_4_0");
			builder.put(grammarAccess.getMessageContentAccess().getIntValueAssignment_2_4_1(), "rule__MessageContent__IntValueAssignment_2_4_1");
			...
			builder.put(grammarAccess.getMessageContentAccess().getStrValueAssignment_3_4_0(), "rule__MessageContent__StrValueAssignment_3_4_0");
			builder.put(grammarAccess.getMessageContentAccess().getIntValueAssignment_3_4_1(), "rule__MessageContent__IntValueAssignment_3_4_1");
