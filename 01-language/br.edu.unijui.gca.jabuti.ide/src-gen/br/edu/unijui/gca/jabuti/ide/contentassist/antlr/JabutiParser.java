...
public class JabutiParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, JabutiGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getConditionAccess().getConditionTermAssignment_0(), "rule__Condition__ConditionTermAssignment_0");
			builder.put(grammarAccess.getConditionAccess().getConditionalExpressionAssignment_1(), "rule__Condition__ConditionalExpressionAssignment_1");
			...
			builder.put(grammarAccess.getNegationTermAccess().getConditionTermAssignment_1_2(), "rule__NegationTerm__ConditionTermAssignment_1_2");
