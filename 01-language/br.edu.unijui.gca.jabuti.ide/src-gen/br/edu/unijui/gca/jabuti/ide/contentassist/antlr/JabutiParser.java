...
public class JabutiParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, JabutiGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getMessageContentAccess().getAlternatives_3(), "rule__MessageContent__Alternatives_3");
			...
			builder.put(grammarAccess.getMessageContentAccess().getGroup_4_2(), "rule__MessageContent__Group_4_2__0");
			...
			builder.put(grammarAccess.getMessageContentAccess().getContentAssignment_3_0(), "rule__MessageContent__ContentAssignment_3_0");
			builder.put(grammarAccess.getMessageContentAccess().getVariableAssignment_3_1(), "rule__MessageContent__VariableAssignment_3_1");
			builder.put(grammarAccess.getMessageContentAccess().getComparisonOperatorAssignment_4_0(), "rule__MessageContent__ComparisonOperatorAssignment_4_0");
			builder.put(grammarAccess.getMessageContentAccess().getExpressionAssignment_4_1(), "rule__MessageContent__ExpressionAssignment_4_1");
			builder.put(grammarAccess.getMessageContentAccess().getTimeUnitAssignment_4_2_1(), "rule__MessageContent__TimeUnitAssignment_4_2_1");
