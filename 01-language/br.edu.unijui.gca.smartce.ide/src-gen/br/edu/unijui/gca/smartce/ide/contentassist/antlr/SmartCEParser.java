...
public class SmartCEParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SmartCEGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPartiesAccess().getAlternatives(), "rule__Parties__Alternatives");
			...
			builder.put(grammarAccess.getSingleVariableAccess().getGroup(), "rule__SingleVariable__Group__0");
			...
			builder.put(grammarAccess.getValueAndDescriptionAccess().getGroup(), "rule__ValueAndDescription__Group__0");
			builder.put(grammarAccess.getValueAndDescriptionAccess().getGroup_1(), "rule__ValueAndDescription__Group_1__0");
			...
			builder.put(grammarAccess.getContractAccess().getVariablesAssignment_15(), "rule__Contract__VariablesAssignment_15");
			builder.put(grammarAccess.getContractAccess().getClausesAssignment_16(), "rule__Contract__ClausesAssignment_16");
			builder.put(grammarAccess.getContractAccess().getActionsAssignment_17(), "rule__Contract__ActionsAssignment_17");
			builder.put(grammarAccess.getVariablesAccess().getVariableAssignment_3(), "rule__Variables__VariableAssignment_3");
			builder.put(grammarAccess.getSingleVariableAccess().getNameAssignment_0(), "rule__SingleVariable__NameAssignment_0");
			builder.put(grammarAccess.getSingleVariableAccess().getValueAndDescriptionAssignment_2(), "rule__SingleVariable__ValueAndDescriptionAssignment_2");
			...
			builder.put(grammarAccess.getValueAndDescriptionAccess().getValueAssignment_0(), "rule__ValueAndDescription__ValueAssignment_0");
			builder.put(grammarAccess.getValueAndDescriptionAccess().getDescriptionAssignment_1_1(), "rule__ValueAndDescription__DescriptionAssignment_1_1");
			...
			builder.put(grammarAccess.getSessionIntervalAccess().getStartAssignment_2(), "rule__SessionInterval__StartAssignment_2");
			builder.put(grammarAccess.getSessionIntervalAccess().getEndAssignment_4(), "rule__SessionInterval__EndAssignment_4");
