...
@after {
	...
	(
		(
			...
			{
				$current = $this_Obligation_1.current;
				afterParserOrEnumRuleCall();
			}
			    |
			{
			...
			{
				$current = $this_Prohibition_2.current;
				afterParserOrEnumRuleCall();
			}
		)
		otherlv_3='{'
...
@after {
	...
	(
		...
		{
			$current = $this_ConditionalTerm_3.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_SessionInterval_4.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_WeekDaysInterval_5.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_TimeInterval_6.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_MaxNumberOfOperation_8.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_MessageContent_9.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleTimeUnitSpec returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getTimeUnitSpecRule()); }
	iv_ruleTimeUnitSpec=ruleTimeUnitSpec
	{ $current=$iv_ruleTimeUnitSpec.current; }
	EOF;

// Rule TimeUnitSpec
ruleTimeUnitSpec returns [EObject current=null]
@init {
	enterRule();
}
@after {
