 ...
 */
package br.edu.unijui.gca.serializer;
...
public class JabutiSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == JabutiPackage.eINSTANCE)
			...
			case JabutiPackage.PROCESS:
				sequence_Process(context, (br.edu.unijui.gca.jabuti.Process) semanticObject); 
				return; 
	...
	protected void sequence_BusinessAction(ISerializationContext context, BusinessAction semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, JabutiPackage.Literals.ACTION__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JabutiPackage.Literals.ACTION__NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_BusinessDay(ISerializationContext context, BusinessDay semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, JabutiPackage.Literals.BUSINESS_DAY__START) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JabutiPackage.Literals.BUSINESS_DAY__START));
			if (transientValues.isValueTransient(semanticObject, JabutiPackage.Literals.BUSINESS_DAY__END) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JabutiPackage.Literals.BUSINESS_DAY__END));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_OnBreach(ISerializationContext context, OnBreach semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, JabutiPackage.Literals.ON_BREACH__ACTION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JabutiPackage.Literals.ON_BREACH__ACTION));
			if (transientValues.isValueTransient(semanticObject, JabutiPackage.Literals.ON_BREACH__MESSAGE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JabutiPackage.Literals.ON_BREACH__MESSAGE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_OnSuccess(ISerializationContext context, OnSuccess semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, JabutiPackage.Literals.ON_SUCCESS__ACTION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JabutiPackage.Literals.ON_SUCCESS__ACTION));
			if (transientValues.isValueTransient(semanticObject, JabutiPackage.Literals.ON_SUCCESS__MESSAGE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JabutiPackage.Literals.ON_SUCCESS__MESSAGE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_OperationLimit(ISerializationContext context, OperationLimit semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, JabutiPackage.Literals.OPERATION_LIMIT__OPERATIONS_NUMBER) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JabutiPackage.Literals.OPERATION_LIMIT__OPERATIONS_NUMBER));
			if (transientValues.isValueTransient(semanticObject, JabutiPackage.Literals.OPERATION_LIMIT__TIME_UNIT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JabutiPackage.Literals.OPERATION_LIMIT__TIME_UNIT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	 ...
	 * </pre>
	 */
	protected void sequence_Process(ISerializationContext context, br.edu.unijui.gca.jabuti.Process semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, JabutiPackage.Literals.PARTY__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JabutiPackage.Literals.PARTY__NAME));
		}
