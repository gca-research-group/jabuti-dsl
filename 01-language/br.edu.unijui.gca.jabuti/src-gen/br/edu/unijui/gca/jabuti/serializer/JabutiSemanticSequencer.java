...
public class JabutiSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == JabutiPackage.eINSTANCE)
			...
			case JabutiPackage.NEGATION_OPERATOR:
				sequence_NegationTerm(context, (NegationOperator) semanticObject); 
				return; 
			...
			case JabutiPackage.TIME_UNIT_SPEC:
				sequence_TimeUnitSpec(context, (TimeUnitSpec) semanticObject); 
				return; 
	 ...
	 *
	 * Constraint:
	 *     (left=ExpressionTerm_BinaryTermOperator_1_0 (symbol='AND' | symbol='OR') right=NegationTerm)
	 * </pre>
	 */
	 ...
	 * <pre>
	 * Contexts:
	 *     ExpressionTerm returns NegationOperator
	 *     ExpressionTerm.BinaryTermOperator_1_0 returns NegationOperator
	 *     NegationTerm returns NegationOperator
	 *     Term returns NegationOperator
	 *
	 * Constraint:
	 *     (symbol='NOT' expressionTerm=Term)
	 * </pre>
	 */
	protected void sequence_NegationTerm(ISerializationContext context, NegationOperator semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, JabutiPackage.Literals.NEGATION_OPERATOR__SYMBOL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JabutiPackage.Literals.NEGATION_OPERATOR__SYMBOL));
			if (transientValues.isValueTransient(semanticObject, JabutiPackage.Literals.NEGATION_OPERATOR__EXPRESSION_TERM) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JabutiPackage.Literals.NEGATION_OPERATOR__EXPRESSION_TERM));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	 ...
	 * <pre>
	 * Contexts:
	 *     TimeUnitSpec returns TimeUnitSpec
	 *
	 * Constraint:
	 *     timeUnit=TimeUnit
	 * </pre>
	 */
	protected void sequence_TimeUnitSpec(ISerializationContext context, TimeUnitSpec semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, JabutiPackage.Literals.TIME_UNIT_SPEC__TIME_UNIT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JabutiPackage.Literals.TIME_UNIT_SPEC__TIME_UNIT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getTimeUnitSpecAccess().getTimeUnitTimeUnitEnumRuleCall_1_0(), semanticObject.getTimeUnit());
		feeder.finish();
	}
