 ...
 * </p>
 * <ul>
 *   <li>{@link br.edu.unijui.gca.jabuti.impl.OperationLimitImpl#getOperationsNumber <em>Operations Number</em>}</li>
 *   <li>{@link br.edu.unijui.gca.jabuti.impl.OperationLimitImpl#getTimeUnit <em>Time Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationLimitImpl extends BusinessRuleImpl implements OperationLimit
{
  ...
  {
		return JabutiPackage.Literals.OPERATION_LIMIT;
	}
  ...
  public void setOperationsNumber(int newOperationsNumber)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JabutiPackage.OPERATION_LIMIT__OPERATIONS_NUMBER, oldOperationsNumber, operationsNumber));
	}
  ...
  public void setTimeUnit(TimeUnit newTimeUnit)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JabutiPackage.OPERATION_LIMIT__TIME_UNIT, oldTimeUnit, timeUnit));
	}
