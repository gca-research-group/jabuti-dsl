 ...
 * </p>
 * <ul>
 *   <li>{@link br.edu.unijui.gca.jabuti.impl.BusinessDayImpl#getStart <em>Start</em>}</li>
 *   <li>{@link br.edu.unijui.gca.jabuti.impl.BusinessDayImpl#getEnd <em>End</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BusinessDayImpl extends BusinessRuleImpl implements BusinessDay
{
  ...
  {
		return JabutiPackage.Literals.BUSINESS_DAY;
	}
  ...
  public void setStart(WeekDay newStart)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JabutiPackage.BUSINESS_DAY__START, oldStart, start));
	}
  ...
  public void setEnd(WeekDay newEnd)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JabutiPackage.BUSINESS_DAY__END, oldEnd, end));
	}
