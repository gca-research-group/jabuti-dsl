 ...
 * </p>
 * <ul>
 *   <li>{@link br.edu.unijui.gca.smartce.smartCE.impl.LogicalOperatorImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LogicalOperatorImpl extends MinimalEObjectImpl.Container implements LogicalOperator
{
	...
	{
		return SmartCEPackage.Literals.LOGICAL_OPERATOR;
	}
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmartCEPackage.LOGICAL_OPERATOR__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case SmartCEPackage.LOGICAL_OPERATOR__NAME:
				return getName();
		}
